...
The mean number of total steps taken for each day is **`r toString(meansteps)`**.  
The median number of total steps taken for each day is **`r toString(medsteps)`**.
...
The time interval with the greatest average number of steps taken is from **`r maxint1`** to **`r maxint2`**.
...
A total of **`r nasum`** data points have missing values.  
...
The mean number of total steps taken for each day is **`r toString(meansteps2)`**.  
The median number of total steps taken for each day is **`r toString(medsteps2)`**  
...
It seems that for most of the day, more steps are taken on Weekend days. However, early in the day on Weekdays, a large number of steps are taken.